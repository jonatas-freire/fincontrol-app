        ...
        <div>
            ...
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'grid'}}>
                ...
                <div style={{ display: 'grid'}}>
                    ...
                    <DiaryAmount>{user?.formattedDiary}</DiaryAmount>
                    <Tomorrow>Projeção para amanhã

                        <br></br>

                        <strong style={{ color: '#29ABE2' }}>{user?.formattedDiary}</strong>
                ...
                <Total>Saldo total <br></br> disponivel
                    ...
                    <strong style={{ color: '#29ABE2', display: 'block' }}>{(user.formattedBalance || 0.0)}</strong>
                </Total> ) }
